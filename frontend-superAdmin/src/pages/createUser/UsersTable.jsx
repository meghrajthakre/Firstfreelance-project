...
export default function UsersTable({ users, loading, onToggle, onChangePassword, onDelete }) {
  if (loading) {
    return <LoadingSpinner colSpan={5} />;
  }

  if (users.length === 0) {
    return <EmptyState colSpan={5} message="No users found." />;
  }
